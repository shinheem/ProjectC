  ...
  <!-- Banner -->
         <div id="banner">
            <article data-position="bottom right">
               <div class="inner">
                   <a href="styling/hipList.jsp"><img src="/imageupload/115.jpg" alt=""></a>
               </div>
            </article>
            <article data-position="bottom right">
               <div class="inner">
                  <a href="styling/hipList.jsp"><img src="/imageupload/114.jpg" alt=""></a>
                  <div class="features">
                  </div>
               </div>
            </article>
            <article data-position="bottom right">
               <div class="inner">
                  <a href="styling/dailyList.jsp"><img src="/imageupload/107.jpg" alt=""></a>
                  <div class="features">
                  </div>
               </div>
            </article>
