...
<body>
			<main id="write">
			<p style="font-size: 100%; font-weight: bolder;">1:1문의 - QnA</p>
<form name="frm1" method="post" action="QnAWriteAction.jsp"  onsubmit="return isValid()">
 <table>
 	<tr><th>제목</th>
 		<td>
 			<input type="text" name="questionTitle" size="50">	
 		</td>
 	</tr>
 	<!-- 작성자는 문제점을 발견하기 위한 추가 사항이고 나중에는 삭제합니다. -->
 	<tr><th>작성자</th>
 		<td>
 			<input type="text" name="questionWriter" size="50" value="${user.id }">	
 		</td>
 	</tr>
 	<tr><th>내용</th>  
 		<td>
 			<textarea  rows="30" cols="80" name="questionContent"></textarea>
 		</td>
 	</tr>
 	<tr>
 	<td colspan="2" align="center">
	 	...
	 	<button type="button" onclick="location.href='QnA.jsp'">목록</button>  
 	</td>
 	</tr>
 </table>
 </form>
